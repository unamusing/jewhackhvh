...
local SaveManager = {} do
    ...
    function SaveManager:SetLibrary(library) self.Library = library
    ...
    function SaveManager:BuildConfigSection(tab)
        ...
        --section:AddDivider() i dont like this
...
section:AddButton('Create Config', function()
        ...
        section:AddButton('Reset Autoload', function()
            ...
            SaveManager.AutoloadLabel:SetText('Autoloading Config: none')
        end)

        self.AutoloadLabel = section:AddLabel("Autoloading Config: " .. self:GetAutoloadConfig(), true)
